...
export const CONFIG = {
  ...
  artists: [
    ...
    { id: 2, name: "???", revealDate: null, isRevealed: true, hiddenImage: `${BASE}images/artists/artist-2-hidden.png`, revealedImage: `${BASE}images/artists/artist-2-revealed.jpg`, altHidden: "Artista 2 — Em breve", altRevealed: "Atração 2" },
