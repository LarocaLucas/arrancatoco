...
export const CONFIG = {
  ...
  tickets: {
    pista: [
      { name: "LOTE RELÂMPAGO", price: "R$ 70,00",  status: "active" },
      { name: "PRIMEIRO LOTE",  price: "R$ 80,00",  status: "upcoming" },
    ...
    camarote: [
      { name: "LOTE RELÂMPAGO", price: "R$ 100,00", status: "active" },
      { name: "PRIMEIRO LOTE",  price: "R$ 115,00", status: "upcoming" },
