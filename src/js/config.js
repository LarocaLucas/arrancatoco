...
export const CONFIG = {
  ...
  artists: [
    ...
    { id: 3, name: "Nog & Pedro Qualy", revealDate: null, isRevealed: true, hiddenImage: `${BASE}images/artists/artist-3-hidden.png`, revealedImage: `${BASE}images/artists/artist-3-revealed.jpg`, altHidden: "Artista 3 — Em breve", altRevealed: "Nog & Pedro Qualy" },
